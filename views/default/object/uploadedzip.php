...
if($zip)
{
	...
	echo '	<div class="file_bulk_import_list_zip">
				<div class="file_bulk_import_list_zip_icon">
				</div>
				...
				<div class="file_bulk_import_list_zip_tools"><a onclick="javascript: if(!confirm(\''.addslashes(elgg_echo('file_bulk_import:deletezipandfiles:confirmtext')).'\')){return false;}" class="file_bulk_import_zip_delete" href="'. $vars['url'].elgg_add_action_tokens_to_url('action/file_bulk_import/zip/delete?guid='.$zip->getGUID()).'" title="('.elgg_echo('file_bulk_import:allfilesincluded').')">'.elgg_echo('delete').'</a></div>
